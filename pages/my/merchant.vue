    ...
    <div v-if="true">
      ...
      <ProgressItem title="完善信息">
        <div class="d-flex">
          ...
          <ContactItem title="实名认证" icon="icon-namecard" :required="true"></ContactItem>
          <ContactItem title="联系人微信" icon="icon-wechat-linear" :active="true" :required="true"></ContactItem>
        </div>
      </ProgressItem>
      <ProgressItem title="提交认证视频">
        ...
        <InfoItem title="提交认证视频" :required="true">
          ...
          <b-form-checkbox>我已发送认证视频道bd@coinex.com邮箱。</b-form-checkbox>
        </InfoItem>
      </ProgressItem>
      ...
      <ProgressItem title="资料审核">
        ...
        <b-form-checkbox class="c-6f">
          我已阅读并同意 <b-link>《认证商家服务协议》</b-link>，并冻结100,000 CET作为商家保证金。
        </b-form-checkbox>
      </ProgressItem>
      <div class="text-center">
        <b-btn variant="gradient-yellow" size="lg" style="width:330px;">提交</b-btn>
      </div>
    </div>
  </CBlock>
</template>
