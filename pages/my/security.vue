...
<template>
  <CBlock class="page-my-security" :x="0" :y="0">
    ...
    <MyInfoItem title="实名认证">
      <p slot="content">{{user.account.kyc_status === constant.KYC_STATUS.PASS ? '已认证' : '未认证'}}</p>
